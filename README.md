...
The user specifies the Event B coordinates (d,t) in an inertial frame, and the velocity (v) of the moving frame as a fraction of c (e.g. v = 0.3c, fixed along the x-axis). 
